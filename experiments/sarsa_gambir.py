...
if __name__ == '__main__':
    ...
    prs = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                  description="""SarsaLambda Gambir""")
    prs.add_argument("-route", dest="route", type=str, default='nets/gambir/gambir.rou.xml', help="Route definition xml file.\n")
    prs.add_argument("-a", dest="alpha", type=float, default=0.00001, required=False, help="Alpha learning rate.\n")
    ...
    out_csv = 'outputs/gambir/sarsa_lambdavai'
